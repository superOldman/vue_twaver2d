  ...
  export default{
      data(){
          return {
            ...
            res:{
              ...
              "obj": [
                {
                  "neId": "7095152F835B952B9F377A3",
                  "neName": "2125-苏州城西苏州城西",
                  "clrcultBoardVoList": [
                    {
                      "boardId": "0D8F76AA1E545FCC",
                      "boardModel": "TN333333",
                      "boardNo": "1_011111",
                      "clrcultPortVoList": [
                        {
                          ...
                          "portCode": "51",
                          "fullname": "2125-苏州城西局城西局-苏州城西-1_0-12-1-522-51(ODU1LP1)",
                      ...
                      "clrcultPortVoList": [
                        {
                          ...
                          "portCode": "53",
                          "fullname": "2125-苏州城西局城西局-苏州城西-1_0-14-1-52NQ2-53(ODU1LP3/ODU1LP3)",
                      ...
                      "clrcultPortVoList": [
                        {
                          ...
                          "portCode": "51",
                          "fullname": "2301-苏州河西局河西局-苏州河西-1_0-1-1-52NQ2-51(ODU1LP1/ODU1LP1)",
                          "linkId": "C22C85794FF6EEFCCEA0051EC42D1386",
                          "odName": "4"
                        }
                      ]
                    },
                      ...
                      "clrcultPortVoList": [
                        {
                          ...
                          "portCode": "53",
                          "fullname": "2301-苏州河西局河西局-苏州河西-1_0-5-1-52NQ2-53(ODU1LP3/ODU1LP3)",
                      ...
                      "clrcultPortVoList": [
                        {
                          ...
                          "portCode": "7",
                          "fullname": "2112-苏州工业园局工业园局-苏州工业园-1_0-30-1-52TOM-7(RX5/TX5)-/och=1/dsr=1(CLIENT-1)",
                          "linkId": '7500F7E155080CC5AD05A004D3353AC4',
                          "odName": null
                        },
                        {
                          "portId": "046CA825118802D33A4BD9AAE8210B5E",
                          "portCode": "205",
                          "fullname": "2112-苏州工业园局工业园局-苏州工业园-1_0-30-1-52TOM-205(ClientLP5/ClientLP5)",
                          "linkId": null,
                          "odName": null
                        }
                      ]
                      ...
                      "clrcultPortVoList": [
                        {
                          ...
                          "portCode": "51",
                          "fullname": "2112-苏州工业园局工业园局-苏州工业园-1_0-5-1-52NQ2-51(ODU1LP1/ODU1LP1)",
                          "linkId": "7095152F835B952B9F377A3E91BA95CE",
                          "odName": "4"
                        }
                      ]
                      ...
                      "clrcultPortVoList": [
                        {
                          ...
                          "portCode": "9",
                          "fullname": "2357-苏州新区科技城局科技城局-苏州东渚科技城-1_0-22-1-52TOM-9(RX7/TX7)-/och=1/dsr=1(CLIENT-1)",
                          "linkId": null,
                          "odName": null
                        },
                        {
                          ...
                          "portCode": "207",
                          "fullname": "2357-苏州新区科技城局科技城局-苏州东渚科技城-1_0-22-1-52TOM-207(ClientLP7/ClientLP7)",
                          "linkId": null,
                          "odName": null
                        }
                      ]
                      ...
                      "clrcultPortVoList": [
                        {
                          ...
                          "portCode": "53",
                          "fullname": "2357-苏州新区科技城局科技城局-苏州东渚科技城-1_0-31-1-52NQ2-53(ODU1LP3/ODU1LP3)",
                          "linkId": "ED39FD69380ECCB2FD073542F4A52D8D",
                          "odName": "4"
                        }
                      ]
      ...
      methods:{
          init(){
            ...
            setTimeout(()=>{
              // me.registerImage('./static/images/gwy.png','gwy');
              me.registerImage('./static/images/car.png','gwy');
            },5000);
          },
          getEleView(){
            let me = this;
            ...
            for(let i in resData){
              let _item = resData[i];
              me.drawNe(i,400*i+80,150,_item.neName,_item.clrcultBoardVoList);
            }
            me.drawLinks();
          },
        drawNe(index,posx,posy,name,clrcultBoardVoList){
          ...
          rect.setImage('rect');
          rect.setName(name);
          rect.setStyle('label.yoffset',44);
        ...
        drawBoard(clrcultBoardVoList,pData,index){
          let me = this;
          let _xyArr = [{x:120+index*400,y:230},{x:260+index*400,y:230}];
        ...
        drawPort(portList,index1,index2,pData){
          ...
          let _xyArr = [];
          if(Number(index2) === 0){
             _xyArr = [{x:112+index1*400,y:262},{x:192+index1*400,y:262}];
          }else{
            _xyArr = [{x:252+index1*400,y:262},{x:332+index1*400,y:262}];
          }
          for(let i in portList){
            let _item = portList[i];
            let _port = 'port'+index1+index2;
            _port = new twaver.Follower({
              id:_item.portId,
              name:_item.portCode,
              location:{
                x:_xyArr[i].x,
        ...
        drawLinks(){
            let me = this;
          let _linkDatas = me._curPortLinkData;
          // console.log(_linkDatas);
          for(let j in _linkDatas){
            let formPort = _linkDatas[j].portData;
            for(let k in _linkDatas){
              if(j !== k){
                if(_linkDatas[k].linkId === _linkDatas[j].portId){
                  let link = new twaver.Link(formPort,me._curPortLinkData[k].portData);
                  link.setName('连线名');
                  link.setStyle('label.color','pink');
                  me.box.add(link);
        ...
        initNetwork(){
          ...
          // twaver.vector.Network.setVScrollBarVisible(false);
        ...
        registerImage(url,name){
          ...
          image.onload = function() {
            twaver.Util.registerImage(name, image, 80, 80);
            image.onload = null;
